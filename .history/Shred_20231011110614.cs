...
public partial class Shred : RigidBody2D
{
	...
	public override void _Process(double delta)
	{
        ...
        // Transform the global position to local coordinates.
        Vector2 localPosition = GetViewport().CanvasItemToLocal(globalPosition);
		...
		{
			GD.Print($"Now Available  {GlobalPosition.Y} {screenHeight}");
			isAvailable = true;
