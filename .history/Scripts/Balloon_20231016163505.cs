...
public partial class Balloon : RigidBody2D
{
	...
	{
		speedTexture = GD.Load("res://Imgs/pups/speed.png") as Texture2D;
		spikeTexture = GD.Load("res://Imgs/pups/spike.png") as Texture2D;
	...
	public void ShuffleAttributes(Powerup pUp = Powerup.None)
	{
		...
		if (powerup != Powerup.None)
		{
			...
			{
				powerupSprite.Texture = speedTexture;
			}
			else if (powerup == Powerup.Spike)
			{
				powerupSprite.Texture = spikeTexture;
			}
			glow.Modulate = color;
			glow.Visible = true;
